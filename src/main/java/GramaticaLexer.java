...
public class GramaticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PRINCIPAL", "SI", "SINO", "MIENTRAS", "IMPRIMIR", "VAR", "MAS", "MENOS", 
			"MULT", "POT", "DIV", "MOD", "Y", "O", "NO", "MAY", "MAYIG", "MEN", "MENIG", 
			"IG", "NOIG", "ASIG", "LLAVE_ABI", "LLAVE_CER", "PAREN_ABI", "PAREN_CER", 
			"CORCH_ABI", "CORCH_CER", "PUNTOYCOM", "BOOLEANO", "NUMERO", "CADENA", 
			"ID", "EB"
		};
	}
